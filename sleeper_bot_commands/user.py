            ...
            if "league" in existing_league:
                ...
                for user in users:
                    ...
                    if user["display_name"] == display_name:
                        ...
                        embed = functions.my_embed('User Information', 'Displays information for the specified user in your league.', discord.Colour.blue(), 'User ID', user["user_id"], False, bot)
