...
from sleeper_bot_commands import (
    league,
    setup,
    weather,
    players,
...
async def on_guild_join(guild):
    ...
    if general and general.permissions_for(guild.me).send_messages:
        await general.send(
            "Happy to be here! Please run the add-league, set-channel, and set-score-type commands to finish setting up!"
        )
...
async def on_guild_remove(guild):
    existing_league = MONGO.servers.find_one({"server": str(guild.id)})
    existing_prefix = MONGO.prefixes.find_one({"server": str(guild.id)})
    if existing_league:
        MONGO.servers.delete_one({"server": str(guild.id)})
    else:
        pass
    if existing_prefix:
        MONGO.prefixes.delete_one({"server": str(guild.id)})
    else:
        pass
    MONGO_CONN.close()
...
@bot.slash_command(
    name="set-channel",
    description="Sets the channel you want to use for automated messages.",
)
@option(
    "channel_id",
    description="Please provide the ID of the channel where you'd like to receive automated messages.",
)
...
@bot.slash_command(
    name="add-league",
    description="Connects your Discord server to your Sleeper league.",
)
@option(
    "league_id",
    description="Please provide the ID of your Sleeper league to retrieve information from.",
)
...
@bot.slash_command(
    name="set-score-type", description="Sets the score type of your specific league."
)
@option(
    "score_type",
    description="Please provide the scoring type that your league uses.",
    choices=["pts_ppr", "pts_half_ppr", "pts_std"],
)
...
@bot.slash_command(
    name="my-league",
    description="Returns general league information. Must run add-league first.",
)
@option(
    "ephemeral",
...
@bot.slash_command(
    name="my-league-standings",
    description="Returns current league standings. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@bot.slash_command(
    ...
    description="Returns matchups for a specific week. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "week", description="Please enter the week number you'd like to view matchups for."
)
...
@bot.slash_command(
    name="my-league-scoreboard",
    description="Returns the scoreboard for a specific week. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "week", description="Please enter the week number you'd like to view scores for."
)
...
@bot.slash_command(
    ...
    description="Returns the top 10 trending players either in being added or dropped.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "add_drop",
    description="Please select whether you'd like to view players being added or dropped.",
    choices=["add", "drop"],
)
...
@bot.slash_command(
    name="roster",
    description="Returns a portion or entirety of a roster. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "username",
    description="Please provide the username of the leaguemate you'd like to view the roster of.",
)
@option(
    "roster_portion",
    description="Please select the portion of the roster you'd like to view.",
    choices=["starters", "bench", "all"],
)
...
@bot.slash_command(
    name="status",
    description="Returns the injury and depth chart status of a given player.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "first_name",
    description="Please provide the first name of the player you want to view the depth chart and injury status for.",
)
@option(
    "last_name",
    description="Please provide the last name of the player you want to view the depth chart and injury status for.",
)
@option(
    "team_abbreviation",
    description="Please provide the team abbreviation in all caps of the player you want to view the status of.",
)
async def status(
    ctx, ephemeral: bool, first_name: str, last_name: str, team_abbreviation: str
):
...
@bot.slash_command(
    name="who-has",
    description="Returns the user who has a given player. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "first_name",
    description="Please provide the first name of the player you want to see the owner of.",
)
@option(
    "last_name",
    description="Please provide the last name of the player you want to see the owner of.",
)
@option(
    "team_abbreviation",
    description="Please provide the team abbreviation in all caps of the player you want to see the owner of.",
)
async def who_has(
    ctx, ephemeral: bool, first_name: str, last_name: str, team_abbreviation: str
):
...
@bot.slash_command(
    name="forecast", description="Returns the 3 day forecast for a city or zip code."
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "city",
    description="Please provide the name of the city or zipcode that you want to view the 3 day forecast for.",
)
...
@bot.slash_command(
    ...
    description="Returns the current weather for a city or zip code.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "city",
    description="Please provide the name of the city or zipcode that you want to view the current weather for.",
)
...
@bot.slash_command(
    name="user-info",
    description="Returns Sleeper user information for a given user. Must run add-league first.",
)
@option(
    "ephemeral",
    description="Select whether or not you'd like the response to be viewable to just you.",
...
@option(
    "display_name",
    description="Please enter the display name of the user you'd like to see information about.",
)
...
@option(
    "member",
    description="Please enter the exact username of the member being unbanned.",
)
...
@bot.slash_command(
    name="find-user",
    description="Finds a given user and returns their server info related to the bot.",
)
@option(
    "member",
    description="Please enter the exact username of the member you want to find the guild ID of.",
)
